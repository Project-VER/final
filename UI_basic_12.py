...
settings = {
    ...
    'responseLength': 'medium'  # Add this line
}
...
@app.route('/')
def index():
    return render_template('index_10.html', bluetooth_connected=bluetooth_connected)
